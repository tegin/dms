...
class Base(models.AbstractModel):
    ...
    @api.model
    def _build_search_childs_domain(self, parent_id, domain=False):
        if not domain:
            domain = []
    ...
    @api.model
    def search_parents(
        self, domain=False, offset=0, limit=None, order=None,
        count=False
    ):
